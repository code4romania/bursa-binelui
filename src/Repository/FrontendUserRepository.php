...
/**
 * @extends ServiceEntityRepository<FrontendUser>
 *
...
class FrontendUserRepository extends ServiceEntityRepository implements PasswordUpgraderInterface
{
    ...
    {
        parent::__construct($registry, FrontendUser::class);
    }

    public function save(FrontendUser $entity, bool $flush = false): void
    {
    ...
    public function remove(FrontendUser $entity, bool $flush = false): void
    {
...
//    /**
//     * @return FrontendUser[] Returns an array of FrontendUser objects
//     */
...
//    public function findOneBySomeField($value): ?FrontendUser
//    {
//        return $this->createQueryBuilder('f')
//            ->andWhere('f.exampleField = :val')
//            ->setParameter('val', $value)
