...
namespace App\Filament\Resources\ContactMessageResource\Actions\Pages;
...
class ToggleMarkAsReadAction extends Action
{
    ...
    protected function setUp(): void
    {
        ...
        $this->icon(fn (ContactMessage $record) => $record->mark_as_read ? 'heroicon-o-x-circle' : 'heroicon-o-check-circle');
        ...
        $this->successRedirectUrl(fn (ContactMessage $record) => ContactMessageResource::getUrl('view', $record));
    }
}
