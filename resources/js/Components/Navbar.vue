            ...
            <div class="flex h-16 justify-between">
                ...
                <div class="hidden lg:ml-6 lg:flex lg:items-center lg:space-x-4">
                    ...
                    <button
                        v-if="$page.props.auth.user"
                        type="button"
                        class="rounded-full bg-white p-1 text-gray-400 hover:text-gray-500 focus:outline-none focus:ring-2 focus:ring-turqoise-500 focus:ring-offset-2">
                    ...
                    >
                        ...
                        <MenuButton class="flex gap-4 items-center rounded-full bg-white text-sm focus:outline-none">
                ...
                <div class="-mr-2 flex items-center lg:hidden">
                    <!-- Mobile menu button -->
                    <DisclosureButton class="inline-flex items-center justify-center rounded-md p-2 text-gray-400 hover:bg-gray-100 hover:text-gray-500 focus:outline-none focus:ring-2 focus:ring-inset focus:ring-turqoise-500">
