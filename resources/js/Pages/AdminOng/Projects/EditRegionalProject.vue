                ...
                <div class="mt-6 border-t border-gray-100">
                    <dl class="divide-y divide-gray-100">
                        ...
                        <div class="grid grid-cols-12 px-4 py-6 bg-gray-100">
                            ...
                            <EditModal
                                @action="editField('identified_need')"
                                class="flex justify-end col-span-1"
                            >
                                <Textarea
                                    class="w-full"
                        ...
                        <div class="grid grid-cols-12 px-4 py-6 bg-white">
                            ...
                            <EditModal
                                @action="editField('proposed_solution')"
                                class="flex justify-end col-span-1"
                            >
                        ...
                        <div class="grid grid-cols-12 px-4 py-6 bg-gray-100">
                            ...
                            <EditModal
                                @action="editField('project_progress')"
                                class="flex justify-end col-span-1"
                            >
                        ...
                        <div class="grid grid-cols-12 px-4 py-6 bg-gray-100">
                            ...
                            <EditModal
                                @action="editField('project_differentiator')"
                                class="flex justify-end col-span-1"
                            >
                        ...
                        <div class="grid grid-cols-12 px-4 py-6 bg-gray-100">
                            ...
                            <EditModal
                                @action="editField('pride_success')"
                                class="flex justify-end col-span-1"
                            >
                        ...
                        <div class="grid grid-cols-12 px-4 py-6 bg-gray-100">
                            ...
                            <EditModal
                                @action="editField('project_budget')"
                                class="flex justify-end col-span-1"
                            >
                        ...
                        <div class="grid grid-cols-12 px-4 py-6 bg-gray-100">
                            ...
                            <EditModal
                                @action="editField('participant_count')"
                                class="flex justify-end col-span-1"
                            >
                                <!-- participant_count -->
                                <Textarea
